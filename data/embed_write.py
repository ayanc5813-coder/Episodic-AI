...
def embed_sample(qa_list, rewrite_path, FILE_EMBEDDING):
    ...
    for j in range(len(record_rewrite)):
        # [robust read, matches v666] a rewrite record key may be session_j or session_first-session_last,
        ...
        # [matches official/v666] skip empty sessions (no sentences) entirely: no sentence_id/topic_id, no embedding,
