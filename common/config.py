...
parser.add_argument("--ca", type=int, default=1, help="LM category index: 0=multi-session,1=single-session-user,2=temporal-reasoning")
...
os.makedirs(base_dir_t.format(dataset=dataset), exist_ok=True)
os.makedirs(base_dir_k.format(dataset=dataset), exist_ok=True)
os.makedirs(base_dir_emb.format(dataset=dataset), exist_ok=True)
